...
if placeId == 6152116144 or placeId == 13883279773 then -- Map 1
...
Test3:AddToggle('Chatlogs', {
 ...
 Test3:AddButton("Infinite Yield",{
    Text = "Infinite Yield"
    Callback = function()
...
SaveManager:SetFolder('WaterHubCommunity/ProjectSlayers/Map1')
SaveManager:BuildConfigSection(Tabs['Settings'])
ThemeManager:ApplyToTab(Tabs['Settings'])
elseif placeId == 11468159863 or placeId == 13881804983 or placeId == 13883059853 then -- Map 2
repeat wait() until game:IsLoaded()
game:GetService("Players").LocalPlayer.Idled:connect(function()
game:GetService("VirtualUser"):ClickButton2(Vector2.new())
end)
...
ThemeManager:SetFolder('WaterHubCommunity')
SaveManager:SetFolder('WaterHubCommunity/ProjectSlayers/Map2')
SaveManager:BuildConfigSection(Tabs['Settings'])
ThemeManager:ApplyToTab(Tabs['Settings'])
...
ThemeManager:SetFolder('WaterHubCommunity')
SaveManager:SetFolder('WaterHubCommunity/ProjectSlayers/Menu')
SaveManager:BuildConfigSection(Tabs['Settings'])
ThemeManager:ApplyToTab(Tabs['Settings'])
elseif placeId == 11468034852 then -- Mugen and Ouw
---- SERVICES // TEST [MUGEN]
